...
-- SELECT * FROM "KARUNA_ANALYTICS"."REPORTING"."SOB_TABLEAU";




-- select count(distinct product_group) from "KARUNA_ANALYTICS"."ADM"."CLAIMS_RX"

-- SELECT count(distinct switch_to) FROM "KARUNA_ANALYTICS"."REPORTING"."SOB_TABLEAU" where quarter = '2022Q2' and patient_count > 0;