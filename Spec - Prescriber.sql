...
CASE
    ...
    ELSE spcl_group
END as spcl_group, class, dosage_type, brand_generic, "76K_HCP", provider_id, ovr_factored_trx_cnt, MONTH_NUM
...
CASE 
    ...
    WHEN spcl_group = 'PEDIATRICS' THEN 'OTHERS'
    ELSE spcl_group
END as spcl_group, class, dosage_type, brand_generic, "76K_HCP", provider_id, ovr_factored_nbrx_cnt, MONTH_NUM
FROM "KARUNA_ANALYTICS"."ADM"."PROVIDER_RX"
)
, T1 AS
(
...
CASE 
    ...
    WHEN spcl_group = 'PEDIATRICS' THEN 'OTHERS'
    ELSE spcl_group
END as spcl_group, class, dosage_type, brand_generic, "76K_HCP", provider_id, schz_factored_nbrx_cnt, MONTH_NUM
FROM "KARUNA_ANALYTICS"."ADM"."PROVIDER_RX"
)
, T1 AS
(
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "76K_HCP" = 'Y' and MONTH_NUM = 1
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "76K_HCP" = 'Y' and MONTH_NUM <= 3
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "76K_HCP" = 'Y' and MONTH_NUM <= 6
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "76K_HCP" = 'Y' and MONTH_NUM <= 12
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "76K_HCP" = 'Y' and MONTH_NUM = 1
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "76K_HCP" = 'Y' and MONTH_NUM <= 3
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "76K_HCP" = 'Y' and MONTH_NUM <= 6
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "76K_HCP" = 'Y' and MONTH_NUM <= 12
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schz_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "76K_HCP" = 'Y' and MONTH_NUM = 1
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schz_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "76K_HCP" = 'Y' and MONTH_NUM <= 3
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schz_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "76K_HCP" = 'Y' and MONTH_NUM <= 6
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schz_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "76K_HCP" = 'Y' and MONTH_NUM <= 12
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
