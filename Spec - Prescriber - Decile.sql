...
CASE
    ...
    ELSE spcl_group
END as spcl_group, class, dosage_type, brand_generic, "decile_2_and_above", provider_id, ovr_factored_trx_cnt, MONTH_NUM
...
from T0
where ovr_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and MONTH_NUM = 1
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
, T18 AS
(
Select class, dosage_type, brand_generic, spcl_group, sum(ovr_factored_trx_cnt) as value1
from T0
where ovr_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and MONTH_NUM = 1
group by 1, 2, 3, 4
)
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and MONTH_NUM <= 3
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and MONTH_NUM <= 6
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and MONTH_NUM <= 12
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
CASE 
    ...
    WHEN spcl_group = 'PEDIATRICS' THEN 'OTHERS'
    ELSE spcl_group
END as spcl_group, class, dosage_type, brand_generic, "decile_2_and_above", provider_id, ovr_factored_nbrx_cnt, MONTH_NUM
FROM "KARUNA_ANALYTICS"."ADM"."PROVIDER_RX"
)
, T1 AS
(
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and MONTH_NUM = 1
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
, T18 AS
(
Select class, dosage_type, brand_generic, spcl_group, sum(ovr_factored_nbrx_cnt) as value1
from T0
where ovr_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and MONTH_NUM = 1
group by 1, 2, 3, 4
)
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and MONTH_NUM <= 3
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and MONTH_NUM <= 6
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and MONTH_NUM <= 12
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
CASE 
    ...
    WHEN spcl_group = 'PEDIATRICS' THEN 'OTHERS'
    ELSE spcl_group
END as spcl_group, class, dosage_type, brand_generic, "decile_2_and_above", provider_id, schiz_factored_trx_cnt, MONTH_NUM
FROM "KARUNA_ANALYTICS"."ADM"."PROVIDER_RX"
)
, T1 AS
(
...
CASE 
    ...
    WHEN spcl_group = 'PEDIATRICS' THEN 'OTHERS'
    ELSE spcl_group
END as spcl_group, class, dosage_type, brand_generic, "decile_2_and_above", provider_id, schz_factored_nbrx_cnt, MONTH_NUM
FROM "KARUNA_ANALYTICS"."ADM"."PROVIDER_RX"
)
, T1 AS
(
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schz_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and MONTH_NUM = 1
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
, T18 AS
(
Select class, dosage_type, brand_generic, spcl_group, sum(schz_factored_nbrx_cnt) as value1
from T0
where schz_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and MONTH_NUM = 1
group by 1, 2, 3, 4
)
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schz_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and MONTH_NUM <= 3
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schz_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and MONTH_NUM <= 6
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schz_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and MONTH_NUM <= 12
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM = 1
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM <= 3
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM <= 6
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM <= 12
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM = 1
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM <= 3
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM <= 6
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where ovr_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM <= 12
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schiz_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM = 1
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schiz_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM <= 3
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schiz_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM <= 6
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schiz_factored_trx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM <= 12
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schz_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM = 1
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schz_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM <= 3
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schz_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM <= 6
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
Select class, dosage_type, brand_generic, spcl_group, provider_id
from T0
where schz_factored_nbrx_cnt > 0 and (SPCL_GROUP is not null and SPCL_GROUP != '' and SPCL_GROUP != 'UNKNOWN') and "decile_2_and_above" = 'Y' and MONTH_NUM <= 12
group by 1, 2, 3, 4, 5
)
-- one 'ALL' data starts
, T2 as
...
CREATE OR REPLACE TABLE "KARUNA_ANALYTICS"."REPORTING"."PRESCRIBER_RX_SUMMARY_SPEC_DECILE" AS
WITH T1 AS
(
  select *, 'Decile_2_and_Above' as "HCPs" from "KARUNA_ANALYTICS"."REPORTING"."PHARMACEUTICAL_DASHBOARD_OUTPUT_TABLE_76KHCP_"
  union
