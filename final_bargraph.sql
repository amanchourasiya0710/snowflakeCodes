CREATE OR REPLACE TABLE "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_76KHCP_1" AS
WITH T0 as
(
select
CASE 
...
CREATE OR REPLACE TABLE "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_76KHCP_5" AS
WITH T0 as
(
select
CASE 
...
CREATE OR REPLACE TABLE "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_76KHCP_9" AS
WITH T0 as
(
select
CASE 
...
CREATE OR REPLACE TABLE "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_76KHCP_13" AS
WITH T0 as
(
select
CASE 
...
CREATE OR REPLACE TABLE "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_76KHCP_" AS
WITH T1 AS
(
  select * from "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_76KHCP_1"
  union
  select * from "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_76KHCP_5"
  union
  select * from "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_76KHCP_9"
  union
  select * from "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_76KHCP_13"
)
select * from T1;

drop table "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_76KHCP_1";
drop table "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_76KHCP_5";
drop table "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_76KHCP_9";
drop table "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_76KHCP_13";

CREATE OR REPLACE TABLE "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_OVERALLHCP_1" AS
WITH T0 as
(
select
CASE 
...
CREATE OR REPLACE TABLE "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_OVERALLHCP_5" AS
WITH T0 as
(
select
CASE 
...
CREATE OR REPLACE TABLE "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_OVERALLHCP_9" AS
WITH T0 as
(
select
CASE 
...
CREATE OR REPLACE TABLE "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_OVERALLHCP_13" AS
WITH T0 as
(
select
CASE 
...
CREATE OR REPLACE TABLE "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_OVERALLHCP_" AS
WITH T1 AS
(
  select * from "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_OVERALLHCP_1"
  union
  select * from "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_OVERALLHCP_5"
  union
  select * from "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_OVERALLHCP_9"
  union
  select * from "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_OVERALLHCP_13"
)
select * from T1;

drop table "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_OVERALLHCP_1";
drop table "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_OVERALLHCP_5";
drop table "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_OVERALLHCP_9";
drop table "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_OVERALLHCP_13";

CREATE OR REPLACE TABLE "Team"."jethwdh1"."PRESCRIBER_RX_SUMMARY_YEAR" AS
WITH T1 AS
(
  select *, '76K' as "HCPs" from "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_76KHCP_"
  union
  select *, 'Overall' as "HCPs" from "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_OVERALLHCP_"
)
select * from T1;

drop table "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_76KHCP_";
drop table "Team"."jethwdh1"."PHARMACEUTICAL_SD_DASHBOARD_OUTPUT_TABLE_OVERALLHCP_";